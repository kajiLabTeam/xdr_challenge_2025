...
from src.request import TrialState
...
class Request:
    ...
    def _get(self, path: str, **kwargs) -> requests.Response:
        ...
        サーバーにGETリクエストを送信する
        """
        request_path = self.server_url / path
        res = requests.get(request_path, **kwargs)
